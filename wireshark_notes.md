...
- `Info`: a summary of packet contents interpreted by Wireshark
...
- searches packet payload or decoded fields for matching text.
...
#### Ethernet II : 
>This item contains details about the packet at the Ethernet level, including the **source and destination MAC addresses** and indicates the encapsulated network layer protocol that the Ethernet packet contains.
